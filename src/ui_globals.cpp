...
volatile bool art_same_album_transition = false;  // Same album track change — keep art visible while re-checking
volatile uint32_t art_last_download_size = 0;     // JPEG byte count of last successfully displayed art
