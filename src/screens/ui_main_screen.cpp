...
void createMainScreen() {
    ...
    lv_obj_set_size(panel_art, SCALE(450), SCALE(480));  // 537x600
    ...
    lv_obj_set_size(panel_right, SCALE(350), SCALE(480));  // 486x600
    lv_obj_set_pos(panel_right, SCALE(450), 0);  // Position at 537px (450 * 1.28)
    ...
    lv_obj_set_pos(btn_settings, SCALE(305), SCALE(18));
    ...
    lv_obj_set_pos(lbl_artist, SCALE(15), SCALE(75));
    lv_obj_set_width(lbl_artist, SCALE(270));
    ...
    lv_obj_set_pos(lbl_title, SCALE(15), SCALE(100));
    lv_obj_set_width(lbl_title, SCALE(270));
    ...
    lv_obj_set_pos(btn_queue, SCALE(295), SCALE(88));
    ...
    lv_obj_set_size(lbl_album, SCALE(270), SCALE(20));
    lv_obj_set_pos(lbl_album, SCALE(15), SCALE(140));
    ...
    lv_obj_set_pos(slider_progress, SCALE(15), SCALE(160));
    lv_obj_set_size(slider_progress, SCALE(320), SCALE(5));
    ...
    lv_obj_set_pos(lbl_time, SCALE(15), SCALE(175));
    ...
    lv_obj_set_pos(lbl_time_remaining, SCALE(287), SCALE(175));
    ...
    // ===== PLAYBACK CONTROLS =====
    int ctrl_y = SCALE(265);
    int center_x = SCALE(175);  // Center of 380px panel scaled
    ...
    lv_obj_set_size(slider_vol, SCALE(240), SCALE(6));
    lv_obj_set_pos(slider_vol, SCALE(65), vol_y + SCALE(17));
    ...
    lv_obj_set_pos(lbl_next_header, SCALE(15), next_y);
    ...
    lv_obj_set_pos(lbl_next_title, SCALE(55), next_y);
    ...
    lv_obj_set_width(lbl_next_title, SCALE(275));
    ...
    lv_obj_set_pos(lbl_next_artist, SCALE(55), next_y + SCALE(18));
    ...
    lv_obj_set_width(lbl_next_artist, SCALE(275));
